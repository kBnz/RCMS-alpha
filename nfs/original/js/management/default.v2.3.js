...
return null;}}
var DelayDoFunction = function(e,t, func){var timer = setInterval(function() {var tPs = j$(e+"[id='"+t+"']").offset().top;var bSc = j$(this).scrollTop() + j$(window).height();if(bSc > tPs && j$(t).css('display') != 'none') {clearInterval(timer);func();}}, 500);}
